...
public class A9Q2 {
    ...
    public static void main(String[] args) {
        ...
        feb23.add(new News(1, "Manikanta", "Ganesh", "comment"));
        feb23.add(new News(2, "Ganesh", "Vamsi", "comment"));
        feb23.add(new News(2, "Sukumar", "Ganesh", "budget "));
        feb23.add(new News(3, "Ganesh", "Rajesh", "costly"));
