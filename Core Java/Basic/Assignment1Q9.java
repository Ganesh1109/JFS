...
class Student {
    ...
    public static int[] MarksEntry() {
        ...
        int i = 1;
        while (i <= 3) {
            System.out.print("please enter the Student marks for subject "+i +" : ");
            int temp = s9.nextInt();
            student[i] = temp;
            i++;
        }
...
public class Assignment1Q9 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total marks of all students : "+AllStudentsTotal);
        System.out.println("Average marks of all students : "+AllStudentsAvg);
        System.out.println("Total marks scored by students in Subject A : "+SubATotal);
        System.out.println("Average marks scored by students in Subject A : "+SubjAAvg);
        System.out.println("Total marks scored by students in Subject B : "+SubBTotal);
        System.out.println("Average marks scored by students in Subject B : "+SubjBAvg);
        System.out.println("Total marks scored by students in Subject C : "+SubCTotal);
        System.out.println("Average marks scored by students in Subject C : "+SubjCAvg);
